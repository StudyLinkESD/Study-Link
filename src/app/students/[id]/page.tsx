  ...
  const students = [
    {
      ...
      description: "Passionné de développement web, je suis particulièrement intéressé par les technologies JavaScript modernes. J'ai réalisé plusieurs projets personnels et cherche une alternance pour approfondir mes connaissances.",
      ...
      recommendations: [
        {
          ...
          content: "Thomas a réalisé un stage de 2 mois dans notre entreprise. Très motivé et compétent, il s'est parfaitement intégré à l'équipe."
        }
      ],
      experiences: [
        {
          ...
          description: "Développement d'interfaces utilisateur avec React et mise en place d'une application d'administration."
        }
      ]
    },
  ];
              ...
              <Card>
                ...
                <CardContent>
                  {student.experiences && student.experiences.length > 0 ? (
                    ...
                    <p className="text-muted-foreground">Aucune expérience professionnelle listée.</p>
                  )}
                </CardContent>
              </Card>
            </TabsContent>
